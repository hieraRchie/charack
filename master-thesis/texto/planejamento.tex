...
Em outro trabalho analisado, o terreno criado sofre ação de erosão ~\cite{terrain_generation}. Charack não utiliza esse conceito, porém faz uso de uma ideia semelhante para fazer o casamento dos conteúdos gerados nos diferentes módulos da aplicação. Um exemplo simples é o encontro do relevo do continente com o oceano, no qual a altura de cada vértice são atenuadas para que um relevo de praia seja criado.
